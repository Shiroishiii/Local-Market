            ...
            <div className='pag-container'>
                ...
                <div className='resumo-container'>
                   ...
                   <div className='info-location'>
                    ...
                    {/* Mostrar o preço do produto após carregar */}
                    {produto && (
                        <h2 className='subtotal-container'>
                            Subtotal <span className='price-container'>Preço: R$ {produto.preco_diaria}</span>
                        </h2>
                    )}
                    <button className='button-location'>Alugar</button>
                </div>
            </div>
        </div>
    )
